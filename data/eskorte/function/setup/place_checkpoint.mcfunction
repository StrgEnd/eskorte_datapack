...
scoreboard players add #max_checkpoints checkpoint_id 1
...
execute as @e[type=armor_stand,tag=new_checkpoint] run scoreboard players operation @s checkpoint_id = #max_checkpoints checkpoint_id
